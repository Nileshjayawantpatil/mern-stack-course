...
function App() {
  ...
  return (
    <>
      ...
      <nav className=
        "navbar navbar-expand-lg dark light bg dark ">
        <a className=
          "navbar-brand" href="#">Nilesh patil</a>
        <div className=
          "container">
          <button className=
            "navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent"
        ...
        <div className=
          ...
          <ul className=
            ...
            <li className=
              "nav-item active">
              <a className=
                "nav-link" href="#">Home <span className=
            ...
            <li className=
              "nav-item">
              <a className=
                "nav-link" href="#"> Skills</a>
            </li>
            <li className=
              "nav-item">
              <a className=
                "nav-link" href="#">Projects</a>

              <li className=
                "nav-item">
                <a className=
                  "nav-link" href="#">Experience</a>
              </li>
              <li className=
                "nav-item">
                <a className=
                  "nav-link" href="#">Contact</a>
      ...
      < section >
          ...
          <div className=
            ...
            <div className=
              ...
              <div className=
                "col-md-12">
                <h1 className=
                  "text-white mb-5">Hi, I'm Nilesh</h1>
                <p>Mern stack Developer with 2 year Experience. mp-5</p>
                <a className=
                  "btn btn-primary btn-lg mb-5">Hire Me</a>
        ...
        <div className=
          "container py-5">
          <h2 className=
            "text-center section-title">About me</h2>
          <div className=
            "row">
            ...
            <div className=
              ...
              <img src="https://images.unsplash.com/photo-1519085360753-af0119f7cbe7" alt="Profile"
                ...
                class Name="w-50 img-fluid rounded shadow " />
                  ...
                  <div className=
                    ...
                    <div className=
                      ...
                      <div className=
                        ...
                        <i className=
                          "fas fa-briefcase fa-2x"></i>
                        <div className=
                          "card-body">
                          <h5 className=
                            "card-title">MERN Stack Developer</h5>
                          <p className=
                            "card-text">
                    ...
                    <div className=
                      ...
                      <div className=
                        ...
                        <div className=
                          "card-body">
                          <h5 className=
                            "card-title">Junior Web Developer</h5>
                          <p className=
                            "card-text">
                ...
                <div className=
                  ...
                  <div className=
                    ...
                    <div className=
                      ...
                      <div className=
                        "card project-card">
                        <img src="https://images.unsplash.com/photo-1556742044-3c52d6e88c62" className=
                          "card-img-top"
                          alt="E-Commerce" />
                        <div className=
                          "card-body">
                          <h5 className=
                            "card-title">E-Commerce Platform</h5>
                          <p className=
                            "card-text">
                          ...
                          <a href="#" className=
                            "btn btn-primary">View Project</a>
                        </div>
                      </div>
                    </div>
                    <div className=
                      ...
                      <div className=
                        ...
                        <div className=
                          "card-body">
                          <h5 className=
                            "card-title">Task Management App</h5>
                          <p className=
                            "card-text">
                    ...
                    <div className=
                      ...
                      <div className=
                        ...
                        <div className=
                          "card-body">
                          <h5 className=
                            "card-title">Personal Portfolio</h5>
                          <p className=
                            "card-text">
                      ...
                      <form className=
                        ...
                        <div className=
                          ...
                          <input type="text" className=
                            "form-control" id="name" placeholder="Nilesh  patil" />
                        </div>
                        <div className=
                          "mb-3">
                          ...
                          <input type="email" className=
                            "form-control" id="email" placeholder="np298267@gmail.com" />
                        </div>
                        <div className=
                          "mb-3">
                          ...
                          <textarea className=
                            "form-control" id="message" rows="5" placeholder="Your Message"></textarea>
                        </div>
